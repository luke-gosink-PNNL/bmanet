...
\begin{figure}[h!]
	\centering
	\includegraphics[keepaspectratio,width=0.9\textwidth]{Figures/RMSE_SE}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics[keepaspectratio,width=0.9\textwidth]{Figures/Exploratory_RMSE}
...
\begin{figure}[h!]
	\centering
	\includegraphics[keepaspectratio,width=0.9\textwidth]{Figures/P_Not_Zero_Per_Stage2}
...
\begin{figure}
	\centering
	\includegraphics[keepaspectratio,width=0.75\textwidth]{Figures/error_bar_plot_no_best_split_1}
...
\begin{figure}
	\centering
	\includegraphics[keepaspectratio,width=0.75\textwidth]{Figures/error_bar_plot_no_best_split_2}
...
\begin{tocentry}
	\centering
	\includegraphics[height=1.4in,keepaspectratio]{Figures/toc-graphic} 
	\mbox{ } \\
	\mbox{ } \\
	Using data from the SAMPL4 challenge, statistical ensemble modeling techniques combined a variety of solvation methods to generate accurate estimates of small molecule solvation energies.
\end{tocentry}
