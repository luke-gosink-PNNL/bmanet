...
\begin{table}[t]
	...
	\begin{tabular}{l|r|c|c|c|c}
		...
		Jiafu et al. & hyb-3 &hours& QM/MD & 2.80 $\pm$ 0.045 & 71\% \\
		...
		Genheden et al.~\cite{Genheden:2014} & hyb-1&hours  & MM-PB/SA & 2.00 $\pm$ 0.022 & 59\%\\
		Weyang et al. & hyb-4 &hours & MM-PB/SA & 1.84 $\pm$ 0.031 & 55\%\\		
...
\begin{table}[t!]
	...
	\begin{tabular}{l|c|c|c|c|c}
		...
		\hline
		 ...
		 12 & 0.93 $\pm$ 0.018 & hyb-4 &  \textbf{1.000}  (vs. Stage 11)& 0.000 & 12\%\\
		 13 & 0.90 $\pm$ 0.017 & hyb-2 & \textbf{1.000}  (vs. Stage 12) &0.000 &  09\%\\															
		 14 & 0.90 $\pm$ 0.018 & hyb-1 & \textbf{1.000}   (vs. Stage 13)& 0.000 & 09\%\\															
		 15 & 0.91 $\pm$ 0.018 & hyb-3 &   0.001 (vs. Stage 14)&  0.000  & 10\%\\																
...
\begin{figure}[h!]
	...
	In general the trend across the different stages of pruning illustrates that methods become increasingly lighter, i.e., the ensemble design process becomes increasingly confident that these methods (e.g., imp-7 and hyb-4) are not needed in the ensemble.
...
\begin{figure}
	...
	\caption{This figure is one of two figures (Figures~\ref{Analysis:Figure4:Compounds1} and~\ref{Analysis:Figure5:Compounds2}) that depict the RMSE (kcal mol$^{-1}$) performance of several methods based on the individual compounds taken from the SAMPL4 challenge: the first, second, and third best-performing methods (i.e., imp-2, imp-8, and alc-3) as well as hyb-3.
	Note that imp-2 and alc-3 are the methods used in the optimal BMA ensemble (Stage 15) and hyb-3 is the final method eliminated from the ensemble (Table~\ref{Analysis:Table2:BMA}) in Stage 16.
...
Methods imp-2 and alc-3 are the methods used in the optimal BMA ensemble and hyb-3 is the final method eliminated from the ensemble (Stage 15 in Table~\ref{Analysis:Table2:BMA}). 
...
\begin{table}[t!]
	...
	\begin{tabular}{lccccccccc}
		\hline
		\hline
		Model  & imp-1 & alc-5 & imp-4 & hyb-3 & imp-5 & alc-2 & hyb-1 & hyb-4 & alc-4\\
		\hline
