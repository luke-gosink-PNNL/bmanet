% FOR ARXIV \documentclass[journal=jpcbfk, manuscript=article]{achemso}
...
% FOR ARXIV \affiliation{Computational and Statistical Analytics Division, Pacific Northwest National Laboratory, Richland, WA 99352, USA}
\address{Computational and Statistical Analytics Division, Pacific Northwest National Laboratory, Richland, WA 99352, USA}
\author{Paul D.\ Whitney}
% FOR ARXIV \affiliation{Advanced Computing, Mathematics, and Data Division, Pacific Northwest National Laboratory, Richland, WA 99352, USA}
\address{Advanced Computing, Mathematics, and Data Division, Pacific Northwest National Laboratory, Richland, WA 99352, USA}
\author{David L.\ Mobley}
% FOR ARXIV \affiliation{Departments of Pharmaceutical Sciences and Chemistry, University of California, Irvine, Irvine, CA 92697}
\address{Departments of Pharmaceutical Sciences and Chemistry, University of California, Irvine, Irvine, CA 92697}
\author{Nathan A.\ Baker}
% FOR ARXIV \affiliation{Advanced Computing, Mathematics, and Data Division, Pacific Northwest National Laboratory, Richland, WA 99352, USA}
% FOR ARXIV \alsoaffiliation{Division of Applied Mathematics, Brown University, Providence, RI 02912, USA}
\address{Advanced Computing, Mathematics, and Data Division, Pacific Northwest National Laboratory, Richland, WA 99352, USA; Division of Applied Mathematics, Brown University, Providence, RI 02912, USA}
...
The risk and uncertainty associated with using one solvation energy method's estimates over any other method is called \emph{statistical model uncertainty}. Like method selection uncertainty, model selection uncertainty is a common source of error in predictive modeling tasks \cite{Raftery:1995, Raftery:1998, Hoeting:1999, Raftery:2005, Volinsky:1997}.  
...
\begin{figure}[h!]
	\centering
	\includegraphics[keepaspectratio,width=0.9\textwidth]{Figures/Component_Model_RMSE}
...
\begin{table}[t!]
	...
	\begin{tabular}{l|c|c|c|c|c}
		...
		Stage	& Ensemble RMSE		& Method 			& $p$-value		& $p$-value		& Improvement \\
				...
				& Mean and Std Dev	& Pruning			& stages)		& imp-2)		& (Stage 16) \\
		\hline
...
\begin{figure}[h!]
	\centering
	\includegraphics[keepaspectratio,width=0.9\textwidth]{Figures/P_Not_Zero_Per_Stage}
...
\begin{figure}
	\centering
	\includegraphics[keepaspectratio,width=0.75\textwidth]{Figures/compounds_1}
...
\begin{figure}
	\centering
	\includegraphics[keepaspectratio,width=0.75\textwidth]{Figures/compounds_2}
	\caption{This figure is one of two figures (Figures~\ref{Analysis:Figure4:Compounds1} and~\ref{Analysis:Figure5:Compounds2}) that depict the RMSE (kcal mol$^{-1}$) performance of several methods based on the individual compounds taken from the SAMPL4 challenge: the first, second and third performing methods (i.e., imp-2, imp-8, and alc-3) as well as exp-3.
